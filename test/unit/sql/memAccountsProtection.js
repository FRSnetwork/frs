...
var validAccount = {
	...
	'address': randomstring.generate({charset: 'numeric', length: 20}) + 'F',
	...
	describe('username update', function () {
		...
		describe('when account with username = null exists', function () {
			...
			before(function (done) {
				...
				noUsernameAccount.address = randomstring.generate({charset: 'numeric', length: 20}) + 'F';
	...
	describe('u_username update', function () {
		...
		describe('when account with u_username = null exists', function () {
			...
			before(function (done) {
				...
				noU_usernameAccount.address = randomstring.generate({charset: 'numeric', length: 20}) + 'F';
